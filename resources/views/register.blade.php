    ...
    <div class="formContainer">
        ...
        <form class="registerForm" method="POST" action="DB_Ops.php" enctype="multipart/form-data">
            ...
            <div class="inputComponent">
                ...
                <input type="text" name="fullName" onchange="validateFullName()" placeholder="Enter your name" required><br>
                <span class="error" name="fullNameError"></span>
            </div>

            <div class="inputComponent">
                <label for="userName">User Name</label>
                <input type="text" name="userName" onchange="validateUserName()" placeholder="Enter your user name" required><br>
                <span class="error" name="userNameError"></span>
            </div>

            <div class="inputComponent">
                <label for="email">Email:</label>
                <input type="email" name="email" onchange="validateEmail()" placeholder="Enter your email" required><br>
            ...
            <div class="inputComponent">
                ...
                <input type="tel" name="phone" placeholder="Enter your phone number" onchange="validatePhone()" required><br>
                <span class="error" name="phoneError"></span>
            </div>

            <div class="inputComponent">
                <label for="address">Address</label>
                <input type="text" name="address" placeholder="Enter your address" required onchange="validateAddress()"><br>
